...
public extension Animatable where Self: UIView {
    ...
    public func rotate(clockwise: Bool = true, completion: AnimatableCompletion? = nil) {
        CALayer.animate({
            ...
            animation.fromValue = clockwise ? 0 : ((360 * Double.pi) / 180)
            animation.toValue = clockwise ? ((360 * Double.pi) / 180) : 0
            animation.duration = CFTimeInterval(self.duration)
            animation.repeatCount = self.repeatCount
    ...
    // MARK: - Private
    fileprivate func animateInWithX(_ x: CGFloat, completion: AnimatableCompletion? = nil) {
        animateIn(x, 0, 1, 1, 1, completion)
    }
    
    fileprivate func animateOutWithX(_ x: CGFloat, alpha: CGFloat, completion: AnimatableCompletion? = nil) {
        animateOut(x, 0, 1, 1, alpha, completion)
    }
    
    fileprivate func animateInWithY(_ y: CGFloat, completion: AnimatableCompletion? = nil) {
        animateIn(0, y, 1, 1, 1, completion)
    }
    
    fileprivate func animateOutWithY(_ y: CGFloat, alpha: CGFloat, completion: AnimatableCompletion? = nil) {
        animateOut(0, y, 1, 1, alpha, completion)
    }
    
    fileprivate func animateInWithX(_ x: CGFloat, scaleX: CGFloat, completion: AnimatableCompletion? = nil) {
        animateIn(x, 0, scaleX, 1, 1, completion)
    }
    
    fileprivate func animateOutWithX(_ x: CGFloat, scaleX: CGFloat, alpha: CGFloat, completion: AnimatableCompletion? = nil) {
        animateOut(x, 0, scaleX, 1, alpha, completion)
    }
    
    fileprivate func animateInWithY(_ y: CGFloat, scaleY: CGFloat, completion: AnimatableCompletion? = nil) {
        animateIn(0, y, 1, scaleY, 1, completion)
    }
    
    fileprivate func animateOutWithY(_ y: CGFloat, scaleY: CGFloat, alpha: CGFloat, completion: AnimatableCompletion? = nil) {
        animateOut(0, y, 1, scaleY, alpha, completion)
    }
    
    fileprivate func animateInWithScaleX(_ scaleX: CGFloat, scaleY: CGFloat, alpha: CGFloat, completion: AnimatableCompletion? = nil) {
        animateIn(0, 0, scaleX, scaleY, alpha, completion)
    }
    
    fileprivate func animateOutWithScaleX(_ scaleX: CGFloat, scaleY: CGFloat, alpha: CGFloat, completion: AnimatableCompletion? = nil) {
        animateOut(0, 0, scaleX, scaleY, alpha, completion)
    }
    
    fileprivate func animateWithAlpha(_ alpha: CGFloat, completion: AnimatableCompletion? = nil) {
    ...
    fileprivate func animateToWithX(_ x: CGFloat, y: CGFloat, completion: AnimatableCompletion? = nil) {
        animateTo(x, y, completion)
    }
    
    fileprivate func animateTo(_ x: CGFloat, _ y: CGFloat, _ completion: AnimatableCompletion? = nil) {
